...
recognition.onresult=function(event)
{
    ...
    if (transcript1.indexOf("helicopter")==0) {
        ...
        comment9.innerHTML="You pronounced correctly and you have a "+voicecomments[Math.floor(Math.random()*3)];
...
recognition1.onresult=function(event)
{
    ...
    if (transcript2.indexOf("catsatonthemat")==0) {
        ...
        comment10.innerhtml="You pronounced correctly and you have a "+voicecomments[Math.floor(Math.random()*3)];
